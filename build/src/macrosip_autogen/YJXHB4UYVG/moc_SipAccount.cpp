...
void *macrosip::SipAccount::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_macrosip__SipAccount.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int macrosip::SipAccount::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void macrosip::SipAccount::registrationStateChanged(RegistrationState _t1, int _t2, const QString & _t3)
{
